...
var Game = {
    ...
    preload : function() {
        ...
        // In our case, that's just two squares - one for the snake and one for the apple
    ...
    create : function() {
        ...
        // We need them to be globally available so the update function can alter them.
        snake = [];             // This will work as a stack, containing the parts of the snake
        ...
        // Beginning at X=150 Y=150 and increasing the X on every iiteration.
        for(var i = 0; i < 10; i++) {
    ...
    update: function() {
        ...
        // A formula to calculate game speed based on score.
    ...
    appleCollision: function() {
        ...
        // This is needed if he apple spawns inside of the snake.
